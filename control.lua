...
local space_factory_layouts = {
	...
	
	{
		...
		overlay_name = "space-factory-2-overlay",
		overlay_x = 0,
		overlay_y = 5,
		rectangles = {
			{
...
function initialize()
	remote.call("factorissimo-layout", "add_factory_layouts", space_factory_layouts)
	remote.call("factorissimo-control", "add_factory_names", space_factory_layouts)
end
